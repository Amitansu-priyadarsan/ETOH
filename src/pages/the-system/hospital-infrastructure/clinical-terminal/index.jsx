...
export default function ClinicalTerminalPage() {
    return (
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            Diagnostic pipelines, bed flows,<br />
                            medication cycles, and specialist<br />
                            referrals happening simultaneously<br />
                    ...
                    <div style={{
                        ...
                        The institutions that deliver consistently<br />
                        excellent care are the ones whose<br />
                        operating infrastructure matches that<br />
                        complexity — whose leadership can see<br />
                        what is happening.
                    </div>

                    {/* Operational Clarity dark card */}
                    <div style={{
                        padding: 48,
                        position: 'relative',
                        background: '#001736',
